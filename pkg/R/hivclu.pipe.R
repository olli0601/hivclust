...
hivc.pipeline.betareg.estimate.risks<- function()
{
	...
	method.risk	<- c('m2B1st.cas','m2Bwmx.cas','m2Bt.cas')
	method.risk	<- c('m2Bwmx.tp1.adj', 'm2Bwmx.tp2.adj', 'm2Bwmx.tp3.adj', 'm2Bwmx.tp4.adj','m2wmx.tp1.adj', 'm2wmx.tp2.adj', 'm2wmx.tp3.adj', 'm2wmx.tp4.adj')
	method.risk	<- c('m2B1st.cas.clu.adj','m2Bwmx.cas.clu.adj','m2Bt.cas.clu.adj','m2Bwmx.tp1.clu.adj', 'm2Bwmx.tp2.clu.adj', 'm2Bwmx.tp3.clu.adj', 'm2Bwmx.tp4.clu.adj')
	...
	dummy	<- sapply(method.risk, function(x)
			{
				...
				cat(cmd)
				#stop()
				cmd			<- hivc.cmd.hpcwrapper(cmd, hpc.q=NA, hpc.nproc=1, hpc.walltime=71, hpc.mem="59800mb")
				outdir		<- paste(DATA,"tmp",sep='/')
