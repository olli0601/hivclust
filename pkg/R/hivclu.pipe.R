...
hivc.pipeline.betareg.estimate.risks<- function()
{
	...
	method.risk		<- c(	'm2BwmxMv.wtn.tp1','m2BwmxMv.wtn.tp2','m2BwmxMv.wtn.tp3','m2BwmxMv.wtn.tp4')
	...
	dummy	<- sapply(method.risk, function(x)
			{
				...
				cat(cmd)
				#stop()
				cmd			<- hivc.cmd.hpcwrapper(cmd, hpc.q=NA, hpc.nproc=1, hpc.walltime=2, hpc.mem="1800mb")
