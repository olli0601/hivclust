...
hivc.pipeline.betareg.estimate.risks<- function()
{
	...
	method.risk			<- c( 	'm5.tA.clu.adj','m5.tiA.clu.adj','m5.tA.tp1.clu.adj','m5.tiA.tp1.clu.adj','m5.tA.tp2.clu.adj','m5.tiA.tp2.clu.adj','m5.tA.tp3.clu.adj','m5.tiA.tp3.clu.adj','m5.tA.tp4.clu.adj','m5.tiA.tp4.clu.adj')
