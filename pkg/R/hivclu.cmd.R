...
#######################################################"
	...
	cmd		<- paste(cmd,	" -infilexml.opt=",infilexml.opt," -infilexml.template=",infilexml.template," -method=",method," -method.nodectime=",method.nodectime," -method.risk=",method.risk, 
							" -method.recentctime=",method.recentctime," -method.PDT=",method.PDT, " -method.Acute=",method.Acute,' -method.brl.bwhost=',method.brl.bwhost,' -method.minQLowerU=',method.minQLowerU,sep='')
