...
######################################################################################
#' @export
hivc.cmd.betareg.estimate.risks<- function(indir, infile, insignat, indircov, infilecov, infiletree, infilexml.opt, infilexml.template, method, method.nodectime, method.risk, method.recentctime, method.PDT, method.Acute, outdir=indir, outfile=infile, prog= PR.BETAREG.ESTRISK, resume=1, verbose=1)
{
	cmd		<- "#######################################################
...
#######################################################"
	...
	cmd		<- paste(cmd," -infilexml.opt=",infilexml.opt," -infilexml.template=",infilexml.template," -method=",method," -method.nodectime=",method.nodectime," -method.risk=",method.risk, " -method.recentctime=",method.recentctime," -method.PDT=",method.PDT, " -method.Acute=",method.Acute,sep='')
