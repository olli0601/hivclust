...
hivc.clu.truepos<- function(clustering, ph.linked, ph.tips.n, verbose=0)
{
	...
	list(	clu.n				= length(clusters),	
			...
			fp.by.sum			= pairs.freqnotinsameclu,	#including linked seqs that do not cluster at all
			fp.by.sum2			= pairs.freqnotinsameclu2,	#only among linked seqs for whom at least 2 cluster
