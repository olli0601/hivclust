...
{
	indir	<- '/Users/Oliver/Dropbox (Infectious Disease)/OR_Work/2015/2015_SA/ACextpol150831'
	...
	indir	<- '/Users/Oliver/Dropbox (Infectious Disease)/OR_Work/2015/2015_SA/ACextpol150830_original'
...
{	
	dir.name	<- DATA  	
	indir		<- paste(dir.name,'ACpolext',sep='/')
